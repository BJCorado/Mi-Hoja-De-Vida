  ...
  return (
    <section className="container my-5 p-4 section">
      ...
      <div className="d-flex justify-content-center gap-4">
                {/* GitHub */}
        <a href="https://github.com/BJCorado" target="_blank" rel="noopener noreferrer"className="text-white fs-2"
        >
          <FaGithub />
        </a>
        ...
        {/* Facebook */}
        <a href="https://www.facebook.com/bjcorado" target="_blank" rel="noopener noreferrer" className="text-white fs-2">
          <FaFacebook />
        </a>
      </div>
    </section>
